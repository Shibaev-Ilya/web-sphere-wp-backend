        ...
        <div class="footer__container">
            ...
            <div class="footer__row footer__bottom">
                ...
                <div class="footer__bottom-links">
                    <a class="footer__copyright" href="/policy" target="_blank" rel="noopener">Политика
                        конфиденциальности</a>
                    <a class="footer__copyright" href="/agreement" target="_blank" rel="noopener">Согласие на обработку
...
<div class="cookie" id="cookie-notification">
    <div class="container cookie__inner">
        ...
        <button class="cookie__btn simple-button  js-cookie-accept">
            <span>Приемлимо</span>
