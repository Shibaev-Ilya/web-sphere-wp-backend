        ...
        <div class="footer__container">
            ...
            <div class="footer__row footer__bottom">
                ...
                <div class="footer__bottom-links">
                    <a class="footer__copyright" href="<?php echo esc_url( '/policy' ) ?>" target="_blank" rel="noopener">Политика
                        конфиденциальности</a>
                    <a class="footer__copyright" href="<?php echo esc_url( '/cookie' ) ?>" target="_blank" rel="noopener">Политика использования
                        файлов cookie</a>
                    <a class="footer__copyright" href="<?php echo esc_url( '/agreement' ) ?>" target="_blank" rel="noopener">Согласие на обработку
